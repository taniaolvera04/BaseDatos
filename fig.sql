...
CREATE TABLE `figura` (
  `id_f` int(4) NOT NULL AUTO_INCREMENT,
  `nombref` varchar(30) NOT NULL,
  `a` double NOT NULL,
  `b` double NOT NULL,
  `c` double NOT NULL,
  `area` double NOT NULL,
  `peri` double NOT NULL,
  PRIMARY KEY (`id_f`)
...
INSERT INTO `figura` VALUES (2,'Cuadrado',3,0,0,9,12);
...
-- Dump completed on 2023-10-18 22:46:08
