...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-11-2024 a las 20:37:03
...
(2, 'Resis', 5, 10, 25, 48),
(11, 'Libreta c.', 32, 64, 120, 36),
(13, 'Hojas de color ', 0.5, 1.5, 65, 17),
(16, 'Cartulina', 0.5, 1.5, 20, 50),
(17, 'Hojas Blancas ', 0.5, 1, 10, 40),
(18, 'Papel Cascaron ', 8, 10, 45, 60),
(19, 'Papel Cascaron 1/4', 4, 6, 40, 60),
(20, 'Plumas de color ', 5, 8, 15, 70),
(21, 'Plumas de gel ', 9, 12, 40, 60),
(22, 'Resistol de barra ', 8, 10, 50, 70),
(23, 'Caja de colores ', 55, 60, 50, 25),
(24, 'Goma', 5, 8, 20, 60),
...
(65, 'Goma de figuras', 15, 20, 62, 47),
(68, 'Libreta raya', 32, 64, 120, 40);
...
(8, 'Tania', 'Olvera', 'Tuyushi', 'BTS', 'Usuario', '276C6');
...
(2, 200, 324.8, '2023-12-19 18:58:56');
...
--
ALTER TABLE `compras`
  MODIFY `folio_c` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT de la tabla `producto`
--
ALTER TABLE `producto`
  MODIFY `id_p` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=69;
...
--
ALTER TABLE `usuario`
  MODIFY `id_u` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT de la tabla `ventas`
--
ALTER TABLE `ventas`
  MODIFY `folio_v` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=201;
